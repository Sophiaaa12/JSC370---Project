...
---
# Introduction:
This dataset is about "Traveller volumes by port of entry and month" from Government of Canada. I have called API to load the dataset from 2018-01-01 to 2019-05-24 due to the limit. It includes details such as **date, port of entry, region, mode of transportation, and the volume of crossings**. Understanding border traffic is essential for transportation planning, security, and economic forecasting.
